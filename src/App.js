...
function App() {
  ...
  return (
    <div className="App">
      ...
      <div className="bg-light py-2 border-bottom">
        <Container fluid className="d-flex justify-content-between align-items-center px-4">
          <div className="info-bar">
            <span className="text-secondary me-3 top-bar-text">Presidente:
              <span className="fw-bold" style={{ color: 'red', fontSize: '20px' }}>+39 333 839 5158</span>
            </span>
            <span className="text-secondary top-bar-text"> Contattaci e Trovaci 
              <Link to="/accoglienza-e-ascolto" className="fw-bold text-primary top-bar-link" onClick={handleClose}>Clicca qui</Link> 
            </span>
          </div>
        </Container>
      </div>
      ...
      {/* Navbar */}
      <Navbar bg="white" expand={false} className="shadow-sm py-4">
        <Container fluid className="d-flex justify-content-between align-items-center position-relative">
          {/* Logo */}
          <Navbar.Brand as={Link} to="/" className="ms-4" style={{ position: 'relative', zIndex: 2 }}>
            <img src={IncontRhoLogo} alt="Logo Associazione IncontRho" className="navbar-logo" />
          </Navbar.Brand>

          {/* Nuova immagine dietro */}
          <img src={NuovaFoto} alt="Nuova Foto" className="floating-image" />
          <img src={NuovaFoto2} alt="Nuova Foto" className="floating-image2" />
          
          {/* Bottoni */}
          <div className="d-flex align-items-center me-4" style={{ position: 'relative', zIndex: 2 }}>
            <Button variant="primary" className="me-3">Dona Ora</Button>
        ...
        <Modal.Body>
          <Container className="py-4">
            <Row className="gy-4 justify-content-start">
              <Col xs={12} sm={6} md={4} lg className="mb-3 title-col-1">
                <h5 className="fw-bold mb-2 text-primary modal-column-title">IncontRho </h5>
              </Col>
              <Col xs={12} sm={6} md={4} lg className="mb-3 title-col-2">
                <h5 className="fw-bold mb-2 text-primary modal-column-title">Cosa Facciamo</h5>
              </Col>
              <Col xs={12} sm={6} md={4} lg className="mb-3 title-col-3">
                <h5 className="fw-bold mb-2 text-primary modal-column-title">Sostienici</h5>
              </Col>
              <Col xs={12} sm={6} md={4} lg className="mb-3 title-col-4">
                <h5 className="fw-bold mb-2 text-primary modal-column-title">News</h5>
              </Col>
              <Col xs={12} sm={6} md={4} lg className="mb-3 title-col-5">
                <h5 className="fw-bold mb-2 text-primary modal-column-title">Campagne</h5>
              </Col>
            </Row>
            ...
            <Row className="gy-4 justify-content-start">
              <Col xs={12} sm={6} md={4} lg className="mb-3 links-col-1">
                <Nav className="flex-column align-items-start">
                  <Nav.Link as={Link} to="/accoglienza-e-ascolto" className="custom-nav-link" onClick={handleClose}>Contatti e <br /> sedi locali</Nav.Link>
                  <Nav.Link as={Link} to="/visione-missione" className="custom-nav-link" onClick={handleClose}>Visione e Missione</Nav.Link>
                  <Nav.Link as={Link} to="/trasparenza" className="custom-nav-link" onClick={handleClose}>Trasparenza e Governance</Nav.Link>
                  <Nav.Link as={Link} to="/la-carta-dei-servizi" className="custom-nav-link" onClick={handleClose}>La Carta dei Servizi</Nav.Link>
                </Nav>
              </Col>
              
              <Col xs={12} sm={6} md={4} lg className="mb-3 links-col-2">
                <Nav className="flex-column align-items-start">
                  <Nav.Link as={Link} to="/progetti-e-attivita" className="custom-nav-link" onClick={handleClose}>Progetti e Attività</Nav.Link>
                  <Nav.Link as={Link} to="/programmi-di-formazione" className="custom-nav-link" onClick={handleClose}>Programmi Formazione</Nav.Link>
              ...
              <Col xs={12} sm={6} md={4} lg className="mb-3 links-col-3">
                <Nav className="flex-column align-items-start">
                  <Nav.Link as={Link} to="/il-tuo-supporto-per-incontrho" className="custom-nav-link" onClick={handleClose}>Il Tuo Supporto per IncontRho</Nav.Link>
                  <Nav.Link as={Link} to="/partnership-e-collaborazioni" className="custom-nav-link" onClick={handleClose}>Partnership e Collaborazioni</Nav.Link>
                  <Nav.Link as={Link} to="/benefici-fiscali-delle-donazioni" className="custom-nav-link" onClick={handleClose}>Benefici Fiscali delle Donazioni</Nav.Link>
                  <Nav.Link as={Link} to="/unisciti-al-nostro-volontariato" className="custom-nav-link" onClick={handleClose}>Unisciti al Nostro Volontariato</Nav.Link>
                  <Nav.Link as={Link} to="/unisciti-al-nostro-attivismo" className="custom-nav-link" onClick={handleClose}>Unisciti al Nostro Attivismo</Nav.Link>
                </Nav>
              </Col>

              <Col xs={12} sm={6} md={4} lg className="mb-3 links-col-4">
                <Nav className="flex-column align-items-start">
                  <span className="custom-nav-link" style={{ cursor: 'default', color: '#6d6dec' }}>-</span>
                </Nav>
              </Col>

              <Col xs={12} sm={6} md={4} lg className="mb-3 links-col-5">
                <Nav className="flex-column align-items-start">
                  <span className="custom-nav-link" style={{ cursor: 'default', color: '#6d6dec' }}>-</span>
                </Nav>
              </Col>
      ...
      {location.pathname === "/" && (
        <>
          <img src={FooterImage} alt="Prato" className="footer-image" />
          <img src={FooterImage2} alt="Prato2" className="footer-image2" />
        </>
      )}
    </div>
  );
